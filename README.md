...
1. Open `Run Dashboard.bat` in a text editor.
2. Update the path to `course_progress.py` inside the .bat file if needed.
3. Copy the `.bat` file into any course folder you want to track.
4. Double-click the `.bat` file — the dashboard will open automatically in your browser.
